...
const NonTWLightAccessory = require('./lib/NonTWLightAccessory');
const DimLightAccessory = require('./lib/DimLightAccessory');
...
const CLASS_DEF = {
    ...
    nontwlight: NonTWLightAccessory,
    dimlight: DimLightAccessory,
